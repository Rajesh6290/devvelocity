        ...
        <div className="mb-2 flex items-center space-x-2 sm:mb-0">
          <div className="relative">
            ...
            <input
              ...
              value={searchValue}
              placeholder="Search"
              className="w-full rounded-lg border bg-white py-2 pl-10 pr-4 sm:w-auto"
  ...
  <T extends Record<string, unknown>>(
    ...
    return (
      <div className={`relative h-fit ${containerClassName}`}>
        <span
          className={`absolute left-0 top-0 z-30 h-full w-1.5 rounded-l-2xl ${options.tableColor}`}
        ></span>
                  ...
                  <tr>
                    ...
                    {options.detailPanel &&
                      options.detailPanelPosition === "left" && (
                        <th
                          className={`border border-gray-200 px-4 py-2 text-center text-sm font-bold uppercase tracking-wider ${options.theme?.headerText}`}
                        >
                      ...
                      (column) =>
                        visibleColumns[column.field as string] && (
                          <th
                            ...
                            } select-none border border-gray-200 uppercase tracking-wider ${
                    ...
                    {actions.length > 0 && (
                      <th className="w-fit text-nowrap border border-gray-200 p-2 text-center text-sm font-bold uppercase tracking-wider text-tertiary">
                    ...
                    {options.detailPanel &&
                      options.detailPanelPosition === "right" && (
                        <th
                          className={`text-nowrap border border-gray-200 px-4 py-2 text-center text-sm font-bold uppercase tracking-wider ${options.theme?.headerText}`}
                        >
                          {options.detailPanelHeader}
                        </th>
                      )}
                                            ...
                                            <div className="text-left">
                                              ...
                                              {shouldShowMore && (
                                                <motion.button
                                                  ...
                                                  className="ml-1 text-sm font-medium text-tertiary-600 underline hover:text-tertiary-800"
                                                >
                                                  {expanded
                                                    ? column.expandable
                                                        .showLessText ||
                                    ...
                                    (action, actionIndex) =>
                                      !action.hidden?.(row) && (
                                        <div
                                          ...
                                          className={
                                            action.className ||
                                            "cursor-pointer text-tertiary-600 hover:text-tertiary-900"
                                          }
